...
public class NPRegistration {
  ...
  @Test
  public void testNPRegistration() throws Exception {
    driver.get(baseUrl + "/");
    driver.findElement(By.cssSelector("a.joinBtn > span")).click();
    driver.findElement(By.id("email_address")).click();
    driver.findElement(By.id("email_address")).clear();
    driver.findElement(By.id("email_address")).sendKeys("test2@weboapps.com");
    ...
    driver.findElement(By.id("joinSubmitBtn")).click();
  }
